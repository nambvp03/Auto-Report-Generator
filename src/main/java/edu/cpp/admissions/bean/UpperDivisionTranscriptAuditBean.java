...
@Entity
@Table(name="upper_div_transcript_report")
public class UpperDivisionTranscriptAuditBean implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5121340642248695757L;
